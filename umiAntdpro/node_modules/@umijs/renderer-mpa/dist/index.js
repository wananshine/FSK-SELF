...
function renderClient(opts) {
  ...
  if (opts.rootElement) {
    var rootElement = typeof opts.rootElement === 'string' ? document.getElementById(opts.rootElement) : opts.rootElement; // @ts-ignore

    ReactDOM[(rootElement === null || rootElement === void 0 ? void 0 : rootElement.hasChildNodes()) ? 'hydrate' : 'render'](rootContainer, rootElement);
  } else {
