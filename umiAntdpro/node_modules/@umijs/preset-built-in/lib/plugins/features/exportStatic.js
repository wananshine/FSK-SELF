...
var _default = api => {
  ...
  api.modifyExportRouteMap( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(function* (defaultRouteMap, {
      ...
      if (typeof (exportStatic === null || exportStatic === void 0 ? void 0 : exportStatic.extraRoutePaths) === 'function') {
        const extraRoutePaths = yield exportStatic === null || exportStatic === void 0 ? void 0 : exportStatic.extraRoutePaths();
  ...
  api.onBuildComplete(({
    ...
    if (!err && ((_api$config = api.config) === null || _api$config === void 0 ? void 0 : _api$config.ssr) && process.env.RM_SERVER_FILE !== 'none') {
