...
function _renderServer() {
  _renderServer = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(opts) {
    var ctx, _opts$plugin$applyPlu, modifyGetInitialPropsCtx, _yield$loadPageGetIni, pageInitialProps, routesMatched, rootContainer, _pageHTML, pageHTML;
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _opts$plugin$applyPlu = opts.plugin.applyPlugins({
              ...
              type: _runtime.ApplyPluginsType.modify,
              initialValue: {}
            }), modifyGetInitialPropsCtx = _opts$plugin$applyPlu.modifyGetInitialPropsCtx; // modify ctx
            ...
            _context3.next = 5;
            return modifyGetInitialPropsCtx(ctx);
