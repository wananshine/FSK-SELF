...
var _default = api => {
  ...
  api.onGenerateFiles( /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    api.writeTmpFile({
      ...
      content: Mustache.render(localeExportsTpl, {
        ...
        reactIntlPkgPath: winPath((0, _path().dirname)(require.resolve('react-intl/package')))
      })
    }); // runtime.tsx
  ...
  api.addEntryCodeAhead(() => `require('./plugin-locale/locale')._onCreate();`.trim()); // watch locale files
