...
var bigfishCompatibleConversions = function bigfishCompatibleConversions(route, props) {
  ...
  var childrenRoutes = indexRoute ? [_objectSpread({
    path: path,
    menu: menu
...
function formatter(props) {
  ...
  return data.filter(function (item) {
    ...
    var localeName = locale !== false && formatMessage ? formatMessage({
      id: locale,
      defaultMessage: name
    }) : name;
    ...
    var _parent$parentKeys = parent.parentKeys,
        ...
        restParent = _objectWithoutProperties(parent, ["parentKeys", "children"]);
...
var memoizeOneFormatter = (0, _memoizeOne.default)(formatter, _lodash.isEqual);
/**
...
var memoizeOneGetBreadcrumbNameMap = (0, _memoizeOne.default)(getBreadcrumbNameMap, _lodash.isEqual);
/**
 * @param routes 路由配置
...
var transformRoute = function transformRoute(routes, locale, formatMessage, ignoreFilter) {
  ...
  var menuData = ignoreFilter ? originalMenuData.filter(function (item) {
    return item;
  }) : defaultFilterMenuData(originalMenuData); // Map type used for internal logic
