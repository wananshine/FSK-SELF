...
export default (function (routes, menu, formatMessage, menuDataRender) {
  var _transformRoute = transformRoute(routes, (menu === null || menu === void 0 ? void 0 : menu.locale) || false, formatMessage),
  ...
  var renderData = transformRoute(menuDataRender(menuData), (menu === null || menu === void 0 ? void 0 : menu.locale) || false, formatMessage);
  return {
