...
export var formIsNull = function formIsNull(props) {
  var item = props.item,
      intl = props.intl,
      form = props.form,
      type = props.type,
  ...
  if (item.renderFormItem) {
    ...
    var defaultRender = function defaultRender(newItem) {
      return React.createElement(FormInputRender, Object.assign({}, _objectSpread({}, props, {
        item: newItem
      }) || null));
    };
...
export var FormInputRender = function FormInputRender(props) {
  ...
  if (!valueType || valueType === 'text') {
    ...
    if (valueEnum) {
      ...
      }, rest, item.formItemProps), parsingValueEnumToArray(valueEnum).map(function (_ref) {
