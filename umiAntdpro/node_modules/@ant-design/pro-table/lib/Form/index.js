...
exports.default = exports.proFormItemRender = exports.FormInputRender = exports.formIsNull = void 0;
...
var formIsNull = function formIsNull(props) {
  var item = props.item,
      intl = props.intl,
      form = props.form,
      type = props.type,
  ...
  if (item.renderFormItem) {
    ...
    var defaultRender = function defaultRender(newItem) {
      return _react.default.createElement(FormInputRender, Object.assign({}, _objectSpread({}, props, {
        item: newItem
      }) || null));
    };

    return item.renderFormItem(restItem, _objectSpread({}, rest, {
      type: type,
...
var FormInputRender = function FormInputRender(props) {
  ...
  if (!valueType || valueType === 'text') {
    ...
    if (valueEnum) {
      ...
      }, rest, item.formItemProps), (0, _util.parsingValueEnumToArray)(valueEnum).map(function (_ref) {
