...
export interface KeyboardItemProps extends HTMLTableDataProps {
    ...
    iconOnly?: boolean;
    onClick: (event: React.TouchEvent<HTMLTableDataCellElement>, value: string) => void;
}
...
declare class CustomKeyboard extends React.Component<any, any> {
    ...
    onKeyboardClick: (e: React.TouchEvent<HTMLTableDataCellElement>, value?: string) => null | undefined;
