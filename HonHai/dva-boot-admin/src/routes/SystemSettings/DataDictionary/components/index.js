                            ...
                            <Row gutter={16}>
                                <Col span={6}>
                                    <Form.Item label="数据类型：" name="dictType">
                                        <Select defaultValue="" onChange={(value)=>{this.handleChange(value)}} placeholder="请选择数据类型">
                                            {
                    ...
                    <Content className={style.className}>
                        ...
                        >
                            <Form refs="dicModal">
                                ...
                                <Form.Item label="数据顺序："  name="dictSort">
                                    <Input defaultValue={formData.dictSort} onChange={(val)=>{this.handleInput(val, 'dictSort')}} placeholder="请输入数据排序" autoComplete="off" />
                                </Form.Item>
                            </Form>
                        </Modal>
                    </Content>
