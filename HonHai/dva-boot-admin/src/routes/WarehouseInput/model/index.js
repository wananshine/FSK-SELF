...
import { ApiProductionLineLoc2Info} from "../../SystemSettings/ProLinePosition/service";
...
import { ApiProductionLineTaskInfo } from "../../SystemSettings/ProLineTask/service";
...
export default modelEnhance({
    ...
    effects: {
        ...
        *init({ payload }, { call, put, select }) {
            ...
            const res = yield call(ApiLocationInfo, {
                pageNum: '',
                pageSize: ''
            });
            if(res && res.code === 200){
            ...
            if(taskTypeResult && taskTypeResult.code === 200){
                yield put({
                    ...
                    payload: {
                        taskOptions: taskTypeResult.rows,
                    },
                });
            }
        },
